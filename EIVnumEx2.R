print('file: EIVnumEx2.R')
print(date())
# Errors in variables (EIV): artificial data, large sample size
# ----------------------------------------------------------------
...
# library(latex2exp)
sflag = 1
if (sflag == 1) { # n=1e3 and true lambda gives perfect MLE results
  # png('EIVnutrientMC230126n1000.png',width=16,height=16,units='cm',res=300)
