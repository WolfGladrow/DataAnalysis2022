print('file: EIVnumEx4.R')
print(date())
# Errors in variables (EIV): artificial data, small sample size, non-normal
# ----------------------------------------------------------------
...
n = 50    # sample size
sigxError = 0.5
sigyError = 14*sigxError # sigyErro/sigxError close, however, not equal to SlopeTrue
...
# library(latex2exp)
sflag = 1
if (sflag == 1) { # n=50 and true lambda gives perfect MLE results, non-normal x
  # png('EIVnutrientMC230127n50nn.png',width=16,height=16,units='cm',res=300)
