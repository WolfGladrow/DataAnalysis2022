...
# png('x1PlotScatter220218s.png',width=16,height=16,units='cm',res=300)
plot(x1,type='p',lwd=4,cex=0.6,col='blue',xaxt='n',yaxt='n',xlab='',ylab='') 
axis(1,cex.axis=1.5)
axis(2,cex.axis=1.5,las=1)
mtext('Data #',side=1,line=3,cex=2)
...
# mtext('Data #',side=1,line=3,cex=2)   ADD LABEL 'Data #' TO 1. AXIS, CHARACTER SIZE 2 TIMES DEFAULT
