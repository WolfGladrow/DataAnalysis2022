...
# png('tDistCDFNormalBook160103R.png',width=16,height=12,units='cm',res=300)
plot(t,t3,type='l',col='blue',xlab='t',ylab='CDFs of normal and t distributions',
     xlim=c(-3,3), ylim=c(0,1),lwd=3,las=1,lty=4)
