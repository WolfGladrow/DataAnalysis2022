...
sflag = 1
if (sflag == 1) {
  # png('Frejectionregion160727red.png',width=16,height=16,units='cm',res=300)
  plot(x0,F0,type='l',lwd=4,col='black',xlab='x',ylab=NA, 
  ...
  text(4.5,0.3,'rejection region for',col='red',cex=1.5)
  text(4.5,0.2,bquote(~alpha == .(alpha)),col='red',cex=1.5)
  Fc3 = round(Fc,3)
