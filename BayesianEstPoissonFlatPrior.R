...
print('Plot:')
library(latex2exp)
# png('PoissonLikeFct30n210620.png',width=16,height=16,units='cm',res=300)
...
text(xt,1.0,paste('mean = ',as.character(round(mean1,3))),col='blue',pos=4,cex=1.5)
text(xt,0.8,paste('sd = ',as.character(round(sd1,3))),col='blue',pos=4,cex=1.5)
