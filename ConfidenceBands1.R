...
# -----------------------------------------------------------------------------
# Results:
# [1] "file: ConfidenceBands1.R"
# [1] "Sat Dec 17 10:32:24 2022"
# [1] "24"    "sample size n"
# [1] "1.95"  "xmean"
# [1] "3.18"  "ymean"
# [1] "22.82" "Sxx"  
# [1] " ---------------------------------------------------"
# [1] "Sort data & simple linear regression (SLM):"
# [1] "1.8568"           "intercept (estimate)"
# [1] "0.6785"           "slope (estimate)"
# [1] " ---------------------------------------------------"
# [1] " Normally distributed residuals? Perform Shapiro-Wilk test:"
# [1] "0.0183"      "p-value Shapiro-Wilk test"
# [1] "Reject H0: residuals from normal PDF, alpha = 0.05"
# [1] "1.2269"      "S=standard error of the regression"
# [1] " ---------------------------------------------------"
# [1] "0.1"                                 
# [2] "alpha (as in Casella & Berger, 2002)"
# [1] " ---------------------------------------------------"
# [1] "Confidence bands: single point confidence interval approximation:"
# [1] "hyperbolic"
# [1] "1.7171" "tc"    
# [1] " ---------------------------------------------------"
# [1] "Confidence bands: (2) Scheffe (1959): hyperbolic"
# [1] "2.2633" "Malpha"
# [1] "or Malpha = sqrt(2*qf(alpha,2,n-2,lower.tail=FALSE))"
# [1] " ---------------------------------------------------"
# [1] "Confidence interval at x = x0: single point confidence interval"
# [1] " ---------------------------------------------------"
# [1] " Gafarian (1964) confidence bands: straight "
# [1] " ---------------------------------------------------"
# [1] "Guess delta from single point CI in middle of x-range"
# [1] "0.4371"     "deltaGuess"
# [1] " ---------------------------------------------------"
# [1] "0.2"   "3.74"  "xL,xU"
# [1] "G64: chose xU, xL such that (xL+xU)/2 = xmean:"
# [1] "0.153333333333333" "3.74"              "xL,xU"            
# [1] "0.9751"                     "sigXi = sd of x = v in M81"
# [1] "0.5"  "cGaf"
# [1] "2e-04"  "dalpha"
# [1] "Try to find delta for given alpha by iteration!"
# [1] "0.1"    "ddelta"
# [1]   "10"  "2e-04"  "-0.00984237779616381" "k,dalpha,out-onemalpha"
# [1] "0.01"   "ddelta"
# [1]   "10"  "2e-04" "-0.00048265612192"    "k,dalpha,out-onemalpha"
# [1] "0.001"  "ddelta"
# [1] "1000" "2e-04" "-3.32474658173432e-05" "k,dalpha,out-onemalpha"
# [1] "1000" "2e-04" "-3.32474658173432e-05" "k,dalpha,out-onemalpha"
# [1] "0.89988563361912" "0.10011436638088"  "-0.000114366380879805" "1-alpha,alpha,out-onemalpha"
# [1] "0.8581" "delta" 
# [1] "1.0528"                        "delta*S = Gafarian half-width"
# [1] " ---------------------------------------------------"
# [1] "Bowden & Graybill (1966):"
# [1] " ---------------------------------------------------"
# [1] " ---------------------------------------------------"
# [1] "1"    "AB66"
# [1] "-0.5436" "rho"    
...
# [1] "10"   "2"    "k,Dg"
# [1] "0.001"   "deltaDg"
# [1] "1000"                  "-0.000133035967385897" "k,out-onemalpha"      
# [1] "1000"  "2.008" "k,Dg" 
# [1] "2.008"  "D (final) = half-width (Bowden66Graybill)"
# [1] "2.01"   "D (final) = half-width (Bowden66Graybill)"
# [1] "B66,Table3,alpha=0.1,n-2=20,A=1,|rh0|=0.3: D=2.05"
# [1] "0.858"                               "deltaB66 = Cstar (Bowden66Graybill)"
# [1] "1.0527"                           "deltaB66*S = Bowden66 half-width"
# [1] "1"     "ratio"
# [1] " ---------------------------------------------------"
# [1] "1.0527" "deltaB66*S = Gafarian half-width (Bowden66)"
# [1] "Sat Dec 17 10:32:30 2022"
# -----------------------------------------------------------------------------
