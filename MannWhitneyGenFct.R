...
xa = seq(-0.5,0.5,1e-3)
# png('GenFct33MWtest180527.png',width=16,height=16,units='cm',res=300)
plot(xa,fx(xa),type='l',lwd=4,col='blue',xlab='x',
       ylab='Generating function f(x;3,3)',las=1,cex.lab=1.5)
# dev.off()