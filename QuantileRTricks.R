...
q = quantile(x,c(alpha/2,1-alpha/2)) # ,na.rm='TRUE') 
qa1 = qnorm(alpha/2)
qa2 = qnorm(1-alpha/2)
...
# ------------------------------------------------------------
# Results:
# "File: QuantileRTricks.R"
# "-2.0675"      "q[1] from random sampling"
# "-1.96"        "qa1 analytic"
#  "1.904"       "q[2] from random sampling"
#  "1.96"        "qa2 analytic"
# ------------------------------------------------------------
# Remarks:
# The argument na.rm='TRUE' in quantile() is required when
#   the data x contain missing value (which is not the case
