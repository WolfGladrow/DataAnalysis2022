...
# png('CovarianceEst200707.png',width=16,height=12,units='cm',res=300)
plot(narr,covEst1,log='x',type='p',lwd=3,col='blue',xlab='log(n)',
       ylab='Covariance, estimated',las=1,cex=0.4,
       ylim=c(min(covEst1,covEst1)-0.01,0.01+max(covEst1,covEst1)),cex.lab=1.5)
  points(narr,covEst2,col='red',pch=24,lwd=3,cex=0.4)
