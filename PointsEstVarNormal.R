...
title(xlab=TeX('$\\hat{\\sigma^2_1} = \\frac{1}{n-1} \\sum_j (x_j - \\hat{\\mu})^2$'),line=4.3,cex.lab=1.5)
...
text(3.5,130,bquote(~mean(hat(sigma)[1]^2) == .(meanvarestr)),col='blue',cex=1.5)
text(3.5,115,bquote(~var(hat(sigma)[1]^2) == .(varvarestr)),col='blue',cex=1.5)
text(3.5,100,bquote(~sd(hat(sigma)[1]^2) == .(sdvarestr)),col='blue',cex=1.5)
