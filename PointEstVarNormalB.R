...
xt = 3
text(xt,1300,bquote(~mean(hat(sigma)[2]^2) == .(meanvarest2r)),col='blue',cex=1.5)
text(xt,1000,bquote(~var(hat(sigma)[2]^2) == .(varvarest2r)),col='blue',cex=1.5)
text(xt,700,bquote(~sd(hat(sigma)[2]^2) == .(sdvarest2r)),col='blue',cex=1.5)
